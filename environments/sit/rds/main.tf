...
module "sitPostgresRds" {
  ...
  # 指定子网组的名称
  db_subnet_group_name = "sit_rds_subnets_group"
  # 删除前备份。true/false
  ...
  storage_type         = "gp3"
  # 指定要关联的安全组列表
  vpc_security_group_ids = [local.secGroups["Sit_private_internal_postgres_SecGroup"]]
